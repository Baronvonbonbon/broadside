...
// BroadsideUpgradable redeploy-migrate-rewire against the fund-holding
// BroadsideBudgetLedger: freeze v1 → v2.migrate(v1) copies budget + refund
...
describe("BroadsideBudgetLedger — upgrade migration (BroadsideUpgradable)", function () {
