...
import { BroadsideTagCurator } from "../typechain-types";
import { HardhatEthersSigner } from "@nomicfoundation/hardhat-ethers/signers";
import { fundSigners } from "./helpers/mine";

// G-6 mirror: bonded appeal mechanism on BroadsideTagCurator.
//
...
describe("BroadsideTagCurator G-6 mirror (bonded appeal)", function () {
  ...
  beforeEach(async function () {
    ...
    const Factory = await ethers.getContractFactory("BroadsideTagCurator");
