...
async function pauseRegistry() {
  ...
  return await (await ethers.getContractFactory("BroadsidePauseRegistry")).deploy(g0.address, g1.address, g2.address);
}

describe("Phase B — BroadsideAdvertiserStake parameter governance", () => {
  async function deploy() {
    const Stake = await ethers.getContractFactory("BroadsideAdvertiserStake");
...
describe("Phase B — BroadsideActivationBonds parameter governance", () => {
  async function deploy() {
    const [owner] = await ethers.getSigners();
    return await (await ethers.getContractFactory("BroadsideActivationBonds")).deploy(
...
describe("Phase B — BroadsideGovernance parameter governance", () => {
  async function deploy() {
    ...
    const [owner] = await ethers.getSigners();
    return await (await ethers.getContractFactory("BroadsideGovernance")).deploy(
...
describe("Phase B — BroadsideMintCoordinator parameter governance", () => {
  async function deploy() {
    return await (await ethers.getContractFactory("BroadsideMintCoordinator")).deploy();
  }
...
describe("Phase B — BroadsideAdvertiserGovernance parameter governance", () => {
  async function deploy() {
    const pr = await pauseRegistry();
    const AdvGov = await ethers.getContractFactory("BroadsideAdvertiserGovernance");
