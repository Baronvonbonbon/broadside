...
import { BroadsideChallengeBonds } from "../typechain-types";
import { HardhatEthersSigner } from "@nomicfoundation/hardhat-ethers/signers";
import { fundSigners } from "./helpers/mine";

// BroadsideChallengeBonds tests (FP-2)
...
describe("BroadsideChallengeBonds", function () {
  let bonds: BroadsideChallengeBonds;

  let owner: HardhatEthersSigner;
  let campaigns: HardhatEthersSigner;   // impersonates BroadsideCampaigns
  let lifecycle: HardhatEthersSigner;   // impersonates BroadsideCampaignLifecycle
  let governance: HardhatEthersSigner;  // impersonates BroadsidePublisherGovernance
  ...
  before(async function () {
    ...
    const Factory = await ethers.getContractFactory("BroadsideChallengeBonds");
