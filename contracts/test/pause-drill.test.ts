...
// BroadsideSettlement reads before every batch (`BroadsideSettlement.sol:593:
...
describe("Pause drill — settlement halt via PauseRegistry", function () {
  ...
  it("FAST HALT: a single guardian stops settlement in one tx (1-of-N)", async function () {
    ...
    // This is the exact gate BroadsideSettlement reads → every settle batch now reverts Paused.
