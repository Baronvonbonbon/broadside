// BroadsideRouter — Stage 1 upgrade ladder (registry + regression).
//
...
describe("BroadsideRouter — Stage 1 upgrade ladder", function () {
  ...
  describe("upgradeContract (Council phase)", function () {
    beforeEach(async () => {
      ...
      // Note: we use council EOA as a stand-in for a real BroadsideCouncil
