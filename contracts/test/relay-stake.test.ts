...
import { BroadsideRelayStake } from "../typechain-types";
import { HardhatEthersSigner } from "@nomicfoundation/hardhat-ethers/signers";
import { mineBlocks, fundSigners } from "./helpers/mine";

// BroadsideRelayStake tests (G-1 first close)
...
describe("BroadsideRelayStake", function () {
  ...
  beforeEach(async function () {
    ...
    const Factory = await ethers.getContractFactory("BroadsideRelayStake");
