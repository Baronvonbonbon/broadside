...
describe("Settlement / Vault structural-ref re-point (cypherpunk posture)", function () {
  ...
  beforeEach(async function () {
    ...
    settlement = await (await ethers.getContractFactory("BroadsideSettlement")).deploy(await pause.getAddress());
  ...
  describe("BroadsidePaymentVault.setSettlement", function () {
    let vault: any;
    beforeEach(async function () {
