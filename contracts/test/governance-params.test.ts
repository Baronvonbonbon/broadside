...
describe("Governance-tunable params: BroadsideGovernance", function () {
...
describe("Governance-tunable params: BroadsideSettlement revenue split", function () {
  ...
  beforeEach(async function () {
    ...
    // BroadsideMintCoordinator (alpha-4 EIP-170 carve-out): mint reward split
    // setters moved here.
    const C = await ethers.getContractFactory("BroadsideMintCoordinator");
