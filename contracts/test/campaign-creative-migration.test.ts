...
describe("BroadsideCampaignCreative — upgrade migration", function () {
  ...
  beforeEach(async function () {
    ...
    pause = await (await ethers.getContractFactory("BroadsidePauseRegistry")).deploy(owner.address, adv.address, pub.address);
    ...
    v1 = await (await ethers.getContractFactory("BroadsideCampaignCreative")).deploy();
