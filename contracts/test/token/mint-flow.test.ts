...
//   2. Deploy BroadsideMintAuthority (issuer of the asset)
//   3. Deploy BroadsideWrapper (mint-gated to authority)
//   4. Deploy BroadsideVesting (5M founder allocation)
...
describe("DATUM token scaffold — end-to-end mint flow", function () {
  ...
  let settlement: HardhatEthersSigner;      // stands in for BroadsideSettlement
  ...
  before(async function () {
    ...
    const VestingF = await ethers.getContractFactory("BroadsideVesting");
