// BroadsideSettlement → BroadsideMintAuthority integration test.
//
...
describe("BroadsideSettlement → BroadsideMintAuthority integration", function () {

  let precompile: AssetHubPrecompileMock;
  let authority: BroadsideMintAuthority;
  let wrapper: BroadsideWrapper;
  let settlement: BroadsideSettlement;
  let coordinator: any; // BroadsideMintCoordinator (alpha-4 EIP-170 carve-out)
  ...
  before(async function () {
    ...
    const AuthorityF = await ethers.getContractFactory("BroadsideMintAuthority");
    ...
    const WrapperF = await ethers.getContractFactory("BroadsideWrapper");
    ...
    const SettlementF = await ethers.getContractFactory("BroadsideSettlement");
    ...
    const PauseF = await ethers.getContractFactory("BroadsidePauseRegistry");
    ...
    // BroadsideMintCoordinator (alpha-4 EIP-170 carve-out): mint state +
    // setters moved here. Settlement calls coordinator.coordinate(...)
    // once per batch.
    const CoordinatorF = await ethers.getContractFactory("BroadsideMintCoordinator");
  ...
  describe("Mint flow via direct authority call (scaffold)", function () {
    ...
    it("via authority directly: a 1 DOT settlement mints 19 DATUM total split 10.45/7.6/0.95", async function () {
      ...
      const AuthF = await ethers.getContractFactory("BroadsideMintAuthority");
      ...
      const WF = await ethers.getContractFactory("BroadsideWrapper");
