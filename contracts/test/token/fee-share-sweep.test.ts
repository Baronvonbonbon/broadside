...
describe("BroadsidePaymentVault → BroadsideFeeShare sweep", function () {

  let precompile: AssetHubPrecompileMock;
  let authority: BroadsideMintAuthority;
  let wrapper: BroadsideWrapper;
  let feeShare: BroadsideFeeShare;
  let paymentVault: BroadsidePaymentVault;
  ...
  before(async function () {
    ...
    const VaultF = await ethers.getContractFactory("BroadsidePaymentVault");
    paymentVault = await VaultF.deploy();

    const FeeShareF = await ethers.getContractFactory("BroadsideFeeShare");
  ...
  describe("Sweep flow", function () {
    ...
    it("Sweep reverts when FeeShare.paymentVault is unset", async function () {
      ...
      const FreshFeeShareF = await ethers.getContractFactory("BroadsideFeeShare");
