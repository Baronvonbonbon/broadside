...
// G-8 first close: time-locked recovery address on BroadsidePaymentVault.
//
...
describe("BroadsidePaymentVault G-8 first close (recovery address)", function () {
  ...
  beforeEach(async function () {
    ...
    const Factory = await ethers.getContractFactory("BroadsidePaymentVault");
