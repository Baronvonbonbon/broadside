...
import { BroadsideCouncilBlocklistCurator } from "../typechain-types";
import { HardhatEthersSigner } from "@nomicfoundation/hardhat-ethers/signers";
import { fundSigners } from "./helpers/mine";

// G-6 first close: bonded appeal mechanism on BroadsideCouncilBlocklistCurator.
//
...
describe("BroadsideCouncilBlocklistCurator G-6 first close (bonded appeal)", function () {
  ...
  beforeEach(async function () {
    ...
    const Factory = await ethers.getContractFactory("BroadsideCouncilBlocklistCurator");
