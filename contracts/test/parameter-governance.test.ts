...
// BroadsideParameterGovernance tests (T1-B)
...
describe("BroadsideParameterGovernance", function () {
  let gov: BroadsideParameterGovernance;
  ...
  before(async function () {
    ...
    const GovFactory = await ethers.getContractFactory("BroadsideParameterGovernance");
  ...
  it("PGV-EX1 end-to-end — PG owns a contract via bootstrap and executes a whitelisted setParams call", async function () {
    ...
    const PG = await ethers.getContractFactory("BroadsideParameterGovernance");
