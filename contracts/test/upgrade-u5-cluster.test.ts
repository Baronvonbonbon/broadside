...
//   BroadsideBudgetLedger  (advertiser escrow)        BroadsidePaymentVault (user/pub pull-pay)
//   BroadsideChallengeBonds (advertiser challenge)     BroadsideActivationBonds (activation pool)
//   BroadsidePublisherStake (publisher bond)           BroadsideAdvertiserStake (advertiser bond)
...
describe("U5 — coordinated funds-cluster rotation (6 fund holders)", function () {
  ...
  beforeEach(async function () {
    ...
    ledgerV1 = await (await ethers.getContractFactory("BroadsideBudgetLedger")).deploy();
    ...
    vaultV1 = await (await ethers.getContractFactory("BroadsidePaymentVault")).deploy();
    ...
    cbV1 = await (await ethers.getContractFactory("BroadsideChallengeBonds")).deploy();
    ...
    abV1 = await (await ethers.getContractFactory("BroadsideActivationBonds"))
    ...
    psV1 = await (await ethers.getContractFactory("BroadsidePublisherStake")).deploy(0, 0, 1);
    ...
    asV1 = await (await ethers.getContractFactory("BroadsideAdvertiserStake")).deploy(0, 0, 1);
...
// holders: the campaign REGISTRY state lives in BroadsideCampaigns and migrates via
// the governance-gated DELEGATECALL passthrough (migrateDelegate →
// BroadsideCampaignsMigrationLogic.importCampaignFull), replaying each campaign's
...
describe("U5 — coordinated registry-tier rotation (Campaigns + Lifecycle)", function () {
  ...
  beforeEach(async function () {
    ...
    pause = await (await ethers.getContractFactory("BroadsidePauseRegistry"))
      .deploy(owner.address, advertiser.address, publisher.address);
    publishers = await (await ethers.getContractFactory("BroadsidePublishers"))
      .deploy(50n, await pause.getAddress());

    // ── Campaigns v1 + a REAL campaign (genuine registry state to migrate) ────
    campaignsV1 = await (await ethers.getContractFactory("BroadsideCampaigns"))
    ...
    lifecycleV1 = await (await ethers.getContractFactory("BroadsideCampaignLifecycle"))
    ...
    logic = await (await ethers.getContractFactory("BroadsideCampaignsMigrationLogic")).deploy();

    lifecycleV2 = await (await ethers.getContractFactory("BroadsideCampaignLifecycle"))
      .deploy(await pause.getAddress(), 1000n);
