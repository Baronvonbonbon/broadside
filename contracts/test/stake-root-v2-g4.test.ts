...
import { BroadsideStakeRootV2 } from "../typechain-types";
import { HardhatEthersSigner } from "@nomicfoundation/hardhat-ethers/signers";
import { mineBlocks, fundSigners } from "./helpers/mine";

// G-4 first close: permissionless inactivity eviction on BroadsideStakeRootV2.
...
describe("BroadsideStakeRootV2 G-4 first close", function () {
  let stakeRoot: BroadsideStakeRootV2;
  ...
  beforeEach(async function () {
    ...
    const Factory = await ethers.getContractFactory("BroadsideStakeRootV2");
