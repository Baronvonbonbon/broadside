...
import { BroadsideStakeRoot } from "../typechain-types";
import { HardhatEthersSigner } from "@nomicfoundation/hardhat-ethers/signers";
import { fundSigners } from "./helpers/mine";

// STAKE-ROOT V1 INVARIANTS
//
// Captured baseline behaviour that BroadsideStakeRootV2 (Resolution 2 from
...
describe("BroadsideStakeRoot — V1 baseline invariants for V2 work", function () {
  let v1: BroadsideStakeRoot;
