...
describe("Path A: BroadsideStakeRoot", function () {
  let stakeRoot: any;
  ...
  beforeEach(async function () {
    ...
    const F = await ethers.getContractFactory("BroadsideStakeRoot");
...
describe("Path A: BroadsideInterestCommitments", function () {
  let ic: any;
  ...
  beforeEach(async function () {
    ...
    const F = await ethers.getContractFactory("BroadsideInterestCommitments");
    ic = await F.deploy();
  });
...
describe("Path A: BroadsideCampaigns minStake + requiredCategory", function () {
...
describe("Path A: BroadsideZKStake withdrawal lockup", function () {
  ...
  beforeEach(async function () {
    ...
    const F = await ethers.getContractFactory("BroadsideZKStake");
