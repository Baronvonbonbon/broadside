// Phase B integration tests for BroadsidePeopleChainXcmBridge.
//
...
describe("BroadsidePeopleChainXcmBridge", function () {
  ...
  let bridge: BroadsidePeopleChainXcmBridge;
  let cache: BroadsidePeopleChainIdentity;
  ...
  beforeEach(async function () {
    ...
    const CacheF = await ethers.getContractFactory("BroadsidePeopleChainIdentity");
    ...
    const BridgeF = await ethers.getContractFactory("BroadsidePeopleChainXcmBridge");
