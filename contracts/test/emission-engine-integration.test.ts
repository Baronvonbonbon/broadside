// Path H Stage 4 integration test — verify BroadsideSettlement's mint hook
// delegates to BroadsideEmissionEngine when wired, and falls back to the legacy
...
describe("MintCoordinator ↔ BroadsideEmissionEngine integration", function () {
  let settlement: any;
  let coordinator: any;
  let engine: any;
  ...
  beforeEach(async function () {
    ...
    const EngineF = await ethers.getContractFactory("BroadsideEmissionEngine");
