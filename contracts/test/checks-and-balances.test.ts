...
import {
  ...
  BroadsideCouncil,
  BroadsideAdvertiserStake,
  BroadsideAdvertiserGovernance,
  BroadsideRouter,
  MockCampaigns,
...
describe("Checks & Balances (CB1-CB7)", function () {
  ...
  before(async function () {
    ...
    pauseReg = await (await ethers.getContractFactory("BroadsidePauseRegistry"))
    ...
    validator = await (await ethers.getContractFactory("BroadsideClaimValidator"))
    ...
    const relay = await (await ethers.getContractFactory("BroadsideRelay"))
  ...
  describe("CB3 + CB7: Council delegation and rate limit", function () {
    ...
    before(async function () {
      ...
      const CouncilF = await ethers.getContractFactory("BroadsideCouncil");
  ...
  describe("CB4: advertiser stake", function () {
    let stake: BroadsideAdvertiserStake;
    let gov: BroadsideAdvertiserGovernance;

    before(async function () {
      stake = await (await ethers.getContractFactory("BroadsideAdvertiserStake"))
        .deploy(parseDOT("1"), parseDOT("0.01"), 100); // base=1 DOT, perDOT=0.01, delay=100 blk
      gov = await (await ethers.getContractFactory("BroadsideAdvertiserGovernance"))
