...
describe("BroadsideActivationBonds: emergency mute (Phase 2b)", function () {
  let bonds: BroadsideActivationBonds;
  ...
  beforeEach(async function () {
    ...
    const BondsFactory = await ethers.getContractFactory("BroadsideActivationBonds");
  ...
  describe("MUTE-V: validator rejection", function () {
    it("validateClaim returns reason 22 when campaign is bond-muted", async function () {
      ...
      // Deploy a real BroadsideClaimValidator with our MockCampaigns as both the
