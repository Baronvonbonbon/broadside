...
describe("BroadsidePublisherReputation — predecessor-chain migration", function () {
  ...
  beforeEach(async function () {
    ...
    v1 = await (await ethers.getContractFactory("BroadsidePublisherReputation")).deploy();
