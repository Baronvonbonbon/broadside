...
// BroadsideRelay integration with BroadsideRelayStake (G-1 first close, pattern (b) augment)
...
describe("BroadsideRelay G-1 integration", function () {
  let relay: BroadsideRelay;
  let relayStake: BroadsideRelayStake;
  ...
  beforeEach(async function () {
    ...
    // Deploy minimal stack for BroadsideRelay constructor.
