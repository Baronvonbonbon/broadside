...
// U3 pagination for BroadsideBudgetLedger: the live Paseo escrow (29 campaigns)
...
describe("BroadsideBudgetLedger — paginated migrate (U3) at 29-campaign scale", () => {
  it("migrates 29 campaigns across batches with no loss; partial window is frozen", async () => {
    ...
    const BL = await ethers.getContractFactory("BroadsideBudgetLedger");
