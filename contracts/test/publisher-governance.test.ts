...
import {
  BroadsidePublisherGovernance,
  BroadsidePublisherStake,
...
// BroadsidePublisherGovernance tests (FP-3)
...
describe("BroadsidePublisherGovernance", function () {
  let gov: BroadsidePublisherGovernance;
  let stakeContract: BroadsidePublisherStake;
  let bondsContract: BroadsideChallengeBonds;
  ...
  before(async function () {
    ...
    // Deploy BroadsidePublisherStake
    ...
    // Deploy BroadsidePublisherGovernance (G-M5: 8th arg is proposeBond; 0 = disabled here)
    const GovFactory = await ethers.getContractFactory("BroadsidePublisherGovernance");
  ...
  describe("Council-arbitrated advertiser fraud claims (#3)", function () {
    ...
    before(async function () {
      ...
      // is the BroadsideCouncil contract address).
      arbiterEOA = voter2;
