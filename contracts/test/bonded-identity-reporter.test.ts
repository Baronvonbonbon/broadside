// BroadsideBondedIdentityReporter unit tests.
//
...
import {
  BroadsideBondedIdentityReporter,
...
describe("BroadsideBondedIdentityReporter", function () {
  ...
  let reporter: BroadsideBondedIdentityReporter;
  ...
  beforeEach(async () => {
    ...
    const RepF = await ethers.getContractFactory("BroadsideBondedIdentityReporter");
