...
import { BroadsideSettlement } from "../typechain-types";
...
// BroadsideSettlementLogicB._processBatch (M1-fix from audit-pass-5) and is
...
describe("BroadsideSettlement userMinAssurance L3 (G-7 close)", function () {
