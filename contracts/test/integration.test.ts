...
describe("Integration", function () {
  ...
  let claimValidator: BroadsideClaimValidator;
  ...
  before(async function () {
    ...
    const CuratorFactory = await ethers.getContractFactory("BroadsideCouncilBlocklistCurator");
    ...
    const LifecycleFactory = await ethers.getContractFactory("BroadsideCampaignLifecycle");
    ...
    const PowEngineFactory = await ethers.getContractFactory("BroadsidePowEngine");
    ...
    const VerifierFactory = await ethers.getContractFactory("BroadsideAttestationVerifier");
  ...
  // =========================================================================
  // P1: Mandatory publisher attestation (BroadsideAttestationVerifier)
  // =========================================================================
  ...
  it("H1: attested settlement with valid publisher co-sig", async function () {
    ...
    const domain = {
      name: "BroadsideAttestationVerifier",
      version: "1",
      chainId: (await ethers.provider.getNetwork()).chainId,
