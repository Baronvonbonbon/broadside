...
// Mirror of BroadsidePublisherGovernance.fileAdvertiserFraudClaim.
//
...
describe("BroadsideAdvertiserGovernance G-3 first close", function () {
  ...
  beforeEach(async function () {
    ...
    const StakeFactory = await ethers.getContractFactory("BroadsideAdvertiserStake");
    stake = await StakeFactory.deploy(0, 0, 10n);

    // AdvertiserGovernance
    const GovFactory = await ethers.getContractFactory("BroadsideAdvertiserGovernance");
