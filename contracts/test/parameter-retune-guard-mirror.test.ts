...
describe("G-10 mirror: ParameterRetuneGuard across governance contracts", function () {
  ...
  describe("BroadsidePublisherGovernance", function () {
    ...
    beforeEach(async function () {
      ...
      const Factory = await ethers.getContractFactory("BroadsidePublisherGovernance");
  ...
  describe("BroadsideAdvertiserGovernance", function () {
    let gov: BroadsideAdvertiserGovernance;

    beforeEach(async function () {
      const Factory = await ethers.getContractFactory("BroadsideAdvertiserGovernance");
  ...
  describe("BroadsideGovernance", function () {
    let gov: BroadsideGovernance;

    beforeEach(async function () {
      const Factory = await ethers.getContractFactory("BroadsideGovernance");
  ...
  describe("BroadsideMintCoordinator", function () {
    let coord: BroadsideMintCoordinator;

    beforeEach(async function () {
      const Factory = await ethers.getContractFactory("BroadsideMintCoordinator");
