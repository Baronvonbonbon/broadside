...
// Exercises the BroadsideUpgradable redeploy-migrate-rewire flow against the
// fund-holding BroadsidePaymentVault: freeze v1 → deploy v2 → v2.migrate(v1) copies
...
describe("BroadsidePaymentVault — upgrade migration (BroadsideUpgradable)", function () {
  let v1: any;
  let v1Addr: string;
  let v2: any;
  let v2Addr: string;
