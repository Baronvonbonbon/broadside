...
import { BroadsidePaymentVault } from "../typechain-types";
...
describe("BroadsidePaymentVault — withdrawUserBySig (gasless)", function () {
  ...
  async function domain() {
    ...
    return { name: "BroadsidePaymentVault", version: "1", chainId, verifyingContract: vaultAddr };
  }
