...
import { BroadsidePublisherStake, BroadsidePublishers, BroadsidePauseRegistry } from "../typechain-types";
import { HardhatEthersSigner } from "@nomicfoundation/hardhat-ethers/signers";
import { mineBlocks, fundSigners } from "./helpers/mine";

// BroadsidePublisherStake tests (FP-1 + FP-4)
...
describe("BroadsidePublisherStake", function () {
  let stake: BroadsidePublisherStake;
  ...
  before(async function () {
    ...
    const Factory = await ethers.getContractFactory("BroadsidePublisherStake");
...
// Tests for BroadsidePublishers.setStakeGate() and stake-bypass logic in registerPublisher().

describe("BroadsidePublishers — stake-gated registration", function () {
