...
/// @title BroadsidePeopleChainIdentity
...
///         lookup from inside `BroadsideSettlement._processBatch` is not feasible
...
contract BroadsidePeopleChainIdentity is IBroadsidePeopleChainIdentity, BroadsideUpgradable {
    ...
    /// @inheritdoc IBroadsidePeopleChainIdentity
    ...
    function _migrate(address oldContract) internal override {
        BroadsidePeopleChainIdentity old = BroadsidePeopleChainIdentity(oldContract);
