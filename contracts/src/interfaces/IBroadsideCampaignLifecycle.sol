...
/// @title IBroadsideCampaignLifecycle
/// @notice Interface for campaign lifecycle transitions extracted from BroadsideCampaigns.
///         Handles complete, terminate, and expire with refund routing through BudgetLedger.
interface IBroadsideCampaignLifecycle {
