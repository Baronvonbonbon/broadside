...
/// @title IBroadsideActivationBonds
...
interface IBroadsideActivationBonds {
    // ── Phases ────────────────────────────────────────────────────────────────
    ...
    /// @notice Open a bond for a new campaign. Called by BroadsideCampaigns at createCampaign.
    ...
    ///         Sets isMuted(cid)=true; BroadsideClaimValidator rejects claims
    ...
    ///         BroadsideClaimValidator on the settlement path.
