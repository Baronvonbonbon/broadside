...
/// @title IBroadsideAdvertiserGovernance
/// @notice CB4: conviction-weighted fraud governance targeting advertisers.
///         Mirrors the relevant subset of IBroadsidePublisherGovernance — slashing
///         path only. Council-arbitrated cross-direction claims continue to
///         flow through BroadsidePublisherGovernance.
interface IBroadsideAdvertiserGovernance {
    struct Proposal {
        address advertiser;
