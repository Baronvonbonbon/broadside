...
/// @title  IBroadsideMintCoordinator
/// @notice Settlement-facing surface for the DATUM-token emission
///         orchestrator. Carved out of BroadsideSettlement for mainnet
///         EIP-170 (alpha-4).
interface IBroadsideMintCoordinator {
    ...
    ///         catch + BroadsideMintFailed event) so settlement is never
