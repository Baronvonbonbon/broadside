...
interface IBroadsideSettlement {
    // -------------------------------------------------------------------------
    // Structs
    // -------------------------------------------------------------------------
    ...
    struct SignedClaimBatch {
        ...
        Claim[] claims;
        uint256 deadlineBlock;   // A9: block.number expiry — matches BroadsideRelay for unit-uniformity
    ...
    /// @notice settleSignedClaims moved to BroadsideDualSig (alpha-4
