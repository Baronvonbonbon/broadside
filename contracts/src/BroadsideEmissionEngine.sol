...
///
/// @dev    Hoisted out of BroadsideSettlement to keep Settlement under EIP-170.
...
contract BroadsideEmissionEngine is BroadsidePlumbingLockable {
    ...
    ///         independent of BroadsideMintAuthority.totalMinted).
    ...
    function _migrate(address oldContract) internal override {
        BroadsideEmissionEngine o = BroadsideEmissionEngine(oldContract);
    ...
    ///         token are all 10-decimal (BroadsideWrapper.decimals() == 10).
