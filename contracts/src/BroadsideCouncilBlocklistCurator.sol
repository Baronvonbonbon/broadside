...
/// @title BroadsideCouncilBlocklistCurator
/// @notice B2 (2026-05-12): Council-driven blocklist implementation of
///         IBroadsideBlocklistCurator. Designed to be plugged into BroadsidePublishers
///         as `setBlocklistCurator(this)`.
///
///         Mutations (`block`, `unblock`) are gated to a designated council
///         address — in production this is the `BroadsideCouncil` contract, which
...
contract BroadsideCouncilBlocklistCurator is IBroadsideBlocklistCurator, PaseoSafeSender, BroadsideUpgradable {

    /// @notice Upgrade ladder version.
    function version() public pure override returns (uint256) { return 1; }

    /// @notice The contract authorized to call block/unblock. Typically BroadsideCouncil.
    ...
    /// @inheritdoc IBroadsideBlocklistCurator
