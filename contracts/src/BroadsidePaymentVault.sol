...
contract BroadsidePaymentVault is IBroadsidePaymentVault, PaseoSafeSender, BroadsideUpgradable, EIP712 {
    ...
    constructor() EIP712("BroadsidePaymentVault", "1") {}
    ...
    // -------------------------------------------------------------------------
    // Enumeration for upgrade migration (BroadsideUpgradable redeploy-migrate-rewire)
    // -------------------------------------------------------------------------
    //
    ...
    // ── §2.1 BroadsideFeeShare integration ────────────────────────────────────
    ...
    /// @dev    The recipient is expected to be a BroadsideFeeShare contract whose
    ...
    /// @inheritdoc IBroadsidePaymentVault
    ...
    // -------------------------------------------------------------------------
    // Upgrade migration (BroadsideUpgradable redeploy-migrate-rewire)
    // -------------------------------------------------------------------------
    ...
    /// @dev    Called by BroadsideUpgradable.migrate (governance-gated; old must be
    ...
    function _migrate(address oldContract) internal override {
        BroadsidePaymentVault old = BroadsidePaymentVault(payable(oldContract));
