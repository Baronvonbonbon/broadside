...
contract BroadsideStakeRoot is BroadsideUpgradable {
    ...
    ///         but still functions. Set via setDeprecated when BroadsideStakeRootV2
    ...
    ///         Used by BroadsideClaimValidator to accept slightly-stale witnesses.
    ...
    function _migrate(address oldContract) internal override {
        BroadsideStakeRoot old = BroadsideStakeRoot(oldContract);
