...
import "./interfaces/IBroadsideAdvertiserGovernance.sol";
...
/// @title BroadsideAdvertiserGovernance
/// @notice CB4: Conviction-weighted fraud proposals targeting advertisers.
///         Sibling of BroadsidePublisherGovernance for the advertiser-stake plane.
///
...
///         BroadsideAdvertiserStake.slash(). Proceeds accumulate in this contract
...
contract BroadsideAdvertiserGovernance is
    IBroadsideAdvertiserGovernance,
    PaseoSafeSender,
    ...
    ParameterRetuneGuard
{
    ...
    // fraud claims. Mirror of BroadsidePublisherGovernance.fileAdvertiserFraudClaim.
    ...
    function _migrate(address oldContract) internal override {
        BroadsideAdvertiserGovernance old = BroadsideAdvertiserGovernance(payable(oldContract));
        quorum = old.quorum();
    ...
    function migrateFundsTo(address successor) external onlyGovernance nonReentrant {
        ...
        if (bal > 0) BroadsideAdvertiserGovernance(payable(successor)).acceptMigration{value: bal}();
    }
