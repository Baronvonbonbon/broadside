...
import "../BroadsidePaymentVault.sol";

/// @dev Test-only successor used to exercise the BroadsideUpgradable
///      redeploy-migrate-rewire flow against BroadsidePaymentVault. A real v2
...
contract MockPaymentVaultV2 is BroadsidePaymentVault {
