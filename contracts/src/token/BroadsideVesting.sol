...
///         at `endTime`.
///
/// @dev Mint flows through `BroadsideMintAuthority.mintForVesting()`, which mints
...
contract BroadsideVesting is BroadsideUpgradable {
    ...
    function release() external whenNotFrozen {
        ...
        released = vested;
        IBroadsideMintAuthority_Vesting(mintAuthority).mintForVesting(beneficiary, toRelease);
