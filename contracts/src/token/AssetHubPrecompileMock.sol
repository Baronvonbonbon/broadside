...
///         so that contracts that integrate it (BroadsideMintAuthority,
///         BroadsideWrapper) can be tested locally without changes.
///
...
contract AssetHubPrecompileMock is BroadsideOwnable {
    ...
    // EVM precompile side. The mock implements the same shape so BroadsideWrapper
