...
contract BroadsidePublisherStake is IBroadsidePublisherStake, PaseoSafeSender, BroadsideFundMigratable {
    ...
    /// @inheritdoc IBroadsidePublisherStake
    ...
    function _migrate(address oldContract) internal override {
        BroadsidePublisherStake old = BroadsidePublisherStake(payable(oldContract));
