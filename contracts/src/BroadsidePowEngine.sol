...
/// @title  BroadsidePowEngine
/// @notice Per-impression proof-of-work engine, carved out of BroadsideSettlement
///         so it can be upgraded independently via BroadsideRouter and
...
contract BroadsidePowEngine is IBroadsidePowEngine, BroadsideUpgradable {
    ...
    function _migrate(address oldContract) internal override {
        BroadsidePowEngine o = BroadsidePowEngine(oldContract);
    ...
    ///         Lock-once; intended to be set to `BroadsideParameterGovernance`.
    ...
    /// @inheritdoc IBroadsidePowEngine
    ...
    /// @inheritdoc IBroadsidePowEngine
    /// @dev Called once per `_processBatch` in BroadsideSettlement with the
