...
/// @title BroadsideIdentityVerifier
...
///
///         Used by BroadsideStakeRootV2.challengeRootBalance to prove
...
///         for reusability.
///
///         Structure mirrors BroadsideZKVerifier (BN254 pairing via the 0x06,
///         0x07, 0x08 precompiles) but for a 1-public-input circuit. VK
///         is set once via setVerifyingKey and locked.
contract BroadsideIdentityVerifier is IBroadsideIdentityVerifier, BroadsideUpgradable {
    ...
    ///         BroadsideStakeRootV2.setIdentityVerifier (which is plumbingLocked-
