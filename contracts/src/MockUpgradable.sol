...
/// @notice Test-only concrete realization of BroadsideUpgradable. Exposes
///         enough surface to exercise the base's mechanics (pause,
///         onlyGovernance, migration round-trip).
contract MockUpgradable is BroadsideUpgradable {
...
contract MockUpgradableV2 is BroadsideUpgradable {
    uint256 public counter;
    uint256 public migrationCounterReceived;
