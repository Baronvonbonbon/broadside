...
/// @title  BroadsidePlumbingLockable
...
///         (BroadsideSettlement, BroadsideClaimValidator, BroadsidePublishers,
///         BroadsideRelayStake, BroadsideBudgetLedger, BroadsideTagSystem) keep theirs; new
///         and converted contracts inherit this mixin instead.
///
/// @dev    Storage: adds a single `plumbingLocked` bool after the
///         BroadsideUpgradable base (and its 50-slot gap), before child storage.
///         Children inheriting this instead of BroadsideUpgradable shift their own
...
abstract contract BroadsidePlumbingLockable is BroadsideUpgradable {
