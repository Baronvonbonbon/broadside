...
/// @title BroadsideAdvertiserStake
/// @notice CB4: Advertiser-side aggregate stake. Mirrors BroadsidePublisherStake.
///
...
///
///         Slash is called by BroadsideAdvertiserGovernance when a fraud proposal
...
///         requestUnstake (same R-H1 pattern as BroadsidePublisherStake).
contract BroadsideAdvertiserStake is IBroadsideAdvertiserStake, PaseoSafeSender, BroadsideFundMigratable {
    ...
    /// @notice Lock-once: wire BroadsideParameterGovernance as the dual-permission
    ...
    function _migrate(address oldContract) internal override {
        BroadsideAdvertiserStake old = BroadsideAdvertiserStake(payable(oldContract));
